...
try {
    ...
    $script = "powershell -NoProfile -ExecutionPolicy Bypass -Command `"67..90|%{[Char]`$PSItem}|%{if(Test-Path `$(`$_+':\AutoPilot\Scripts\run.ps1')){&`$(`$_+':\AutoPilot\Scripts\run.ps1') -ProfileName '$name' -Phase '2'}}`"" 
